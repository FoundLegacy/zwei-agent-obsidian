...
function ErrorModalComponent({
  ...
  return (
    <div className="za-error-modal-content">
      <div className="za-error-modal-message">{message}</div>
      {log && <pre className="za-error-modal-log">{log}</pre>}
        ...
        {options.showReportBugButton && (
          <button
            ...
            onClick={() => {
              onClose()
              window.open(
                'https://github.com/glowingjade/zwei-agent-obsidian/issues',
                '_blank',
              )
            }}
          >
        ...
        {options.showSettingsButton && (
          <button
            ...
            onClick={() => {
              ...
              app.setting.open()
              // @ts-expect-error: setting property exists in Obsidian's App but is not typed
              app.setting.openTabById('zwei-agent-obsidian')
            }}
          >
            Open Settings
          </button>
