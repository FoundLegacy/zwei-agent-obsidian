...
const ChatUserInput = forwardRef<ChatUserInputRef, ChatUserInputProps>(
  (
    ...
    return (
      <div className="za-chat-user-input-container" ref={containerRef}>
        <div className="za-chat-user-input-files">
          <SystemPromptBadge />
          <ToolBadge />
          <VaultBadge />
          {mentionables.map((m) => (
        ...
        <div className="za-chat-user-input-controls">
          <div className="za-chat-user-input-controls__model-select-container">
            <ModelSelect />
          </div>
          <div className="za-chat-user-input-controls__buttons">
...
function MentionableContentPreview({
  ...
  return displayFileContent ? (
    <div className="za-chat-user-input-file-content-preview">
