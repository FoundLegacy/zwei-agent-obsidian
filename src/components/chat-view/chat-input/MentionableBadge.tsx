...
function BadgeBase({
  ...
  return (
    <div
      className={`za-chat-user-input-file-badge ${isFocused ? 'za-chat-user-input-file-badge-focused' : ''}`}
      onClick={onClick}
    >
      {children}
      <div
        className="za-chat-user-input-file-badge-delete"
        onClick={(evt) => {
          evt.stopPropagation()
          onDelete()
        }}
...
function CurrentFileBadge({
  ...
  return mentionable.file ? (
    <BadgeBase onDelete={onDelete} onClick={onClick} isFocused={isFocused}>
      ...
      <div
        className={clsx(
          'za-chat-user-input-file-badge-name-suffix',
          !settings.chatOptions.includeCurrentFileContent &&
            'za-excluded-content',
        )}
      >
...
function BlockBadge({
  ...
  return (
    <BadgeBase onDelete={onDelete} onClick={onClick} isFocused={isFocused}>
      ...
      <div className="za-chat-user-input-file-badge-name-suffix">
