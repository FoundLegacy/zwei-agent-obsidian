...
function TitleInput({
  ...
  return (
    <input
      ...
      type="text"
      value={value}
      className="za-chat-list-dropdown-item-title-input"
  ...
  return (
    ...
    >
      {isEditing ? (
        ...
        <div className="za-chat-list-dropdown-item-title">{title}</div>
      )}
      <div className="za-chat-list-dropdown-item-actions">
        <button
          onClick={(e) => {
            e.stopPropagation()
            onStartEdit()
...
export function ChatListDropdown({
  ...
  return (
    <Popover.Root open={open} onOpenChange={setOpen}>
      ...
      <Popover.Portal>
        <Popover.Content
          className="za-popover za-chat-list-dropdown-content"
          onKeyDown={handleKeyDown}
        >
          <div className="za-chat-list-dropdown-header">
            Chat History
          </div>
          <ul>
            {chatList.length === 0 ? (
              <li className="za-chat-list-dropdown-empty">
                No conversations
              </li>
            ) : (
